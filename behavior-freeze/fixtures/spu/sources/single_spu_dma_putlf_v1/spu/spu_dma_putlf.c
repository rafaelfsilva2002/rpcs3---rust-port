// single_spu_dma_putlf_v1 — SPU side
// CC0 1.0 (public domain). See ../LICENSE.md.
//
// R8.4f-b — MFC PUTLF list-DMA + fence dispatch (cmd=0x26).
...
#define MFC_PUTLF      ((uint32_t)0x26)
#define SPU_SENTINEL   ((uint32_t)0xC0FFEEBFu)
