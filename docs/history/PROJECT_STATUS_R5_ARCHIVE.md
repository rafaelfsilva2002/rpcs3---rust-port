# PROJECT_STATUS — R5 / pre-R6 historical archive

**Archived 2026-05-03 at R6 closure.** The content below is the verbatim authoritative status text from R5.9e.7 → R5.11 → R5.11b period (last updated 2026-04-29), preserved here for historical context after [`docs/PROJECT_STATUS.md`](../PROJECT_STATUS.md) was rewritten for R6 closure. **Nothing here is current.** For current state see the live `docs/PROJECT_STATUS.md`.

Cross-references inside this archive use relative paths assuming the file lives at `docs/history/PROJECT_STATUS_R5_ARCHIVE.md` (so `../../rust/...` instead of `../rust/...`). Link rot is acceptable in archived material — the link targets themselves may have moved or been renamed since.
